...
- **Google-inspired:** Should look and feel like a Google app bar (e.g., Calendar, Tasks). Use Google's color palette, spacing, and iconography where possible. UI components or native elements should be styled to match Google's design system.

## Style
- Background: #ffffff
- Font: Roboto 16px bold for title; 14px medium for buttons
- Button color: #1a73e8; text only; padding 8px
- Use UI components from a component library for buttons, styled with custom CSS variables for Google-like appearance
